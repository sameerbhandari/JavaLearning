...
class ThreadState implements Runnable {
  ...
  public void callMainImplementation() {
    // creating an object of the class MultiThreadng.ThreadState
    obj = new ThreadState();
    t1 = new Thread(obj);
    ...
    System.out.println(
      "The state of thread t1 after spawning it - " + t1.getState()
    );
  ...
  public void run() {
    ...
    System.out.println(
      "The state of thread t2 after spawning it - " + t2.getState()
    );
    t2.start();
